...
## Daily Robotics use instructions
...
conda activate dr
cd Reasoning/
python -m llava.serve.gradio_web_server --controller-url http://34.28.14.255:10000 --worker-url http://34.28.14.255:40000
```
5- in browser run: http://localhost:7860/
