...
title_markdown = ("""
# DailyRobotics Demo: Reasoning and planning based on visual & Language models
First insert image and then the system will be able to generate reasoned text based on the prompet the user inserts. 
""")
...
learn_more_markdown = ("""
### Credits
In this Demo we are making use of the open source [[Project Page]](https://llava-vl.github.io)
""")
        ...
        with gr.Row():
            with gr.Column(scale=3):
                ...
                gr.Examples(examples=[
                    [f"{cur_dir}/examples/Pepper2.jpg", "How is this pepper harvested?"],
                    [f"{cur_dir}/examples/tomato3.jpg", "What do we see in the picture?"],
                    [f"{cur_dir}/examples/broccoli3.jpg", "What is the challenges in picking this plant?"],
...
if __name__ == "__main__":
    ...
    demo.queue(concurrency_count=args.concurrency_count, status_update_rate=10,
        ...
        server_name=args.host, server_port=args.port, share=args.share, favicon_path="favicon/DailyRobotics_favicon.PNG")
